...
export class TransactionPartenaritMapper {
  toPublicData(transaction: TransactionPartenariat, page?: PagePartenariat) {
    return {
      ...
      prix_unitaire: transaction.prix_unitaire ? parseFloat(transaction.prix_unitaire.toString()) : 0,
      prix_total: transaction.prix_total ? parseFloat(transaction.prix_total.toString()) : 0,
